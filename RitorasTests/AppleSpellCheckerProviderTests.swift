...
final class AppleSpellCheckerProviderTests: XCTestCase {
    ...
    func test_empty_word_returns_empty() {
        let context = SuggestionContext(currentWord: "", lookupWord: "", previousWord: nil, previousWord2: nil, isMidWord: false)
    ...
    func test_known_misspelling_returns_corrections() {
        let context = SuggestionContext(currentWord: "teh", lookupWord: "teh", previousWord: nil, previousWord2: nil, isMidWord: false)
    ...
    func test_partial_word_returns_completions() {
        let context = SuggestionContext(currentWord: "appl", lookupWord: "appl", previousWord: nil, previousWord2: nil, isMidWord: false)
        let result = provider.suggest(for: context, limit: 5)
    ...
    func test_correct_word_may_return_completions() {
        ...
        let context = SuggestionContext(currentWord: "hello", lookupWord: "hello", previousWord: nil, previousWord2: nil, isMidWord: false)
        let result = provider.suggest(for: context, limit: 5)
